...
const nightPDF = (function () {
  ...
  function main() {
    _appContainerElement = document.getElementById("appContainer") as HTMLElement;
    ...
    _darkConfiguratorElement = document.getElementById("darkConfigurator") as HTMLElement;
    _brightnessSliderElement = document.getElementById("brightnessSlider") as HTMLElement;
    _grayscaleSliderElement = document.getElementById("grayscaleSlider") as HTMLElement;
    _invertSliderElement = document.getElementById("invertSlider") as HTMLElement;
    ...
    _splashExtraElement = document.getElementById("splash-extra") as HTMLElement;
